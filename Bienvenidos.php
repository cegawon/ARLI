                ...
                <div class="owl-carousel">                    
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <p>
                            Nos alegra tenerte de vuelta. ¡Disfruta tu visita!
                            </p>
                            <div class="" style="display: flex; flex-direction: column;">
                                <?php if ($_SESSION['rol'] == 'Administrador') {?>
                                <a class="btn mb-2" href="Cliente.php">Crear Cliente</a> <?php }?>
                                <a class="btn mb-2" href="Consulta_Clientes.php">Consultar Clientes</a>
                                <?php if ($_SESSION['rol'] == 'Administrador') {?>
                                <a class="btn mb-2" href="Creditos_Aprobados.php">Creditos Aprobados</a><?php }?>
                                <?php if ($_SESSION['rol'] == 'Administrador') {?>
                                <a class="btn mb-2" href="Consultar_Creditos_Aprobados.php">Consultar Creditos Aprobados</a><?php }?>
                                <a class="btn mb-2" href="Turnos.php">Turnos</a>
                                <a class="btn mb-2" href="Consultar_Turnos.php">Consultar Turnos</a>                         
                            </div>
                        </div>
                    </div>                    
                </div>
