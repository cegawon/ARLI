...
<body>
    ...
    <div class="container" style="margin-top: 150px;">
        <div class="card shadow p-4">
            <h2 class="text-center mb-4">CREDITOS APROBADOS</h2>
            <form action="Guardar_Creditos_Aprobados.php" method="POST">
                <div class="row">
                    <div class="col-md-6">
            ...
            if (isset($_SESSION['aprobado'])) {
                if ($_SESSION['aprobado'] == 1) {
                    ...
                    <div id="mensaje" class="alert alert-success mt-3 text-center" role="alert">
                        ¡Los Datos Fueron Guardados!
                    </div>
                <?php   } else {
                    unset($_SESSION['aprobado']); ?>
                    <div id="mensaje" class="alert alert-danger mt-3 text-center" role="alert">
                        ¡El Número de Cedula no esta Registrado!
                    </div>
            <?php   }
            }
            ?>
